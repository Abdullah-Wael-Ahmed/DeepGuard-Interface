                ...
                <aside className="w-64 bg-background-dark p-4 flex flex-col justify-between border-r border-gray-800 h-screen sticky top-0">
                    <div className="flex flex-col gap-8">
                        ...
                        <nav className="flex flex-col gap-2">
                            <a className="flex items-center gap-3 px-3 py-2 text-text-secondary hover:text-text-main hover:bg-card-dark rounded-lg transition-colors" href="#">
                            ...
                            <a className="flex items-center gap-3 px-3 py-2 rounded-lg bg-primary/20 text-primary shadow-glow-primary border border-primary/50" href="#">
