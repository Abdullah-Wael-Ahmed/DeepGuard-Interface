...
export default function Dashboard() {
  ...
  const alerts = [
    ...
    },
    {
      ...
      source: "Network Segment A",
      severity: "medium",
      time: "2 hr ago",
      status: "active",
    },
    {
      type: "IDS Signature Match",
      source: "Firewall Zone B",
      severity: "low",
      time: "5 hr ago",
      status: "acknowledged",
    },
    ...
    <div className="p-6 space-y-6 bg-[#fff] min-h-screen">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="p-6 bg-[#0A2342] shadow-card text-white">
          <div className="flex items-center justify-between mb-4">
            ...
            <TrendingUp className="w-5 h-5 text-muted-foreground  text-white" />
          </div>
          <div className="h-64 bg-muted/20 rounded-lg flex items-center justify-center  text-white">
        ...
        <Card className="p-6 bg-[#0A2342] shadow-card text-white">
          <div className="flex items-center justify-between mb-4">
            ...
            <button className="text-sm text-primary hover:text-primary/80  text-white">
              View All
            </button>
          </div>
              ...
              >
                <div className="flex-1">
                  <div className="flex items-center gap-3  text-white">
                    ...
                    <div>
                      <p className="font-medium text-foreground  text-white">
                        {alert.type}
                      </p>
      ...
      <Card className="p-6 bg-[#0A2342] shadow-card text-white">
        <div className="flex items-center gap-3 mb-4">
          ...
          <p className="text-sm text-muted-foreground">
            Operational status of core DeepGuard modules
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 ">
          <div className="flex items-center justify-between p-4 rounded-lg border border-border  text-white">
          ...
          <div className="flex items-center justify-between p-4 rounded-lg border border-border">
            <span className="font-medium text-foreground  text-white">IDS/IPS Engine</span>
            <StatusBadge variant="operational">Operational</StatusBadge>
          </div>
          <div className="flex items-center justify-between p-4 rounded-lg border border-border">
            <span className="font-medium text-foreground  text-white">
