      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            AI-powered threat detection and security incident management
          </p>
        </div>
      ...
      <Card className="p-6 bg-[#0A2342] text-white shadow-card">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <Select value={statusFilter} onValueChange={setStatusFilter}>
            <SelectTrigger className="w-[120px] text-[#0A2342]">
      ...
      <Card className="bg-[#0A2342] text-white shadow-card">
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead>
              <tr className="border-b border-border bg-muted/20 text-white">
            ...
            <tbody>
              {filteredAlerts.map((alert) => (
                <tr
                  key={alert.id}
                  className="border-b border-border hover:bg-muted/10 transition-colors text-white"
                >
                  <td className="p-4">
